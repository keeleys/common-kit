...
public class ImageMarkLogoUtil {
    ...
    public static void markImageByText(String logoText, String srcImgPath,
        ...
        try {
            ...
            if(positionHeight==0) positionHeight=buffImg.getHeight()-10;
            // 2、得到画笔对象
            Graphics2D g = buffImg.createGraphics();
            // 3、设置对线段的锯齿状边缘处理
            g.setRenderingHint(RenderingHints.KEY_INTERPOLATION,RenderingHints.VALUE_INTERPOLATION_BILINEAR);
    ...
    public static void main(String [] args){
    	String dir = "E:/tianjun/temp/";
        String srcImgPath = dir+"0.jpg";  
        String logoText = "清关专用";
       // String iconPath = "d:/shuimu.jpg";  
         
        String targerTextPath = dir+"qie_text.jpg";  
       // String targerTextPath2 = dir+"qie_text_rotate.jpg";
         
      //  String targerIconPath = dir+"qie_icon.jpg";  
      //  String targerIconPath2 = dir+"qie_icon_rotate.jpg";
